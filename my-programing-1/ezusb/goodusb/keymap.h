...
#define KEY_Z 0x1d // Keyboard z and Z
  ...
  #define KEY_0 0x27 // Keyboard 0
  #define KEY_ENTER 0x28 // Keyboard Return (ENTER)
  #define KEY_ESC 0x29 // Keyboard ESCAPE
  #define KEY_BACKSPACE 0x2a // Keyboard DELETE (Backspace)
  #define KEY_TAB 0x2b // Keyboard Tab
  #define KEY_SPACE 0x2c // Keyboard Spacebar
  #define KEY_MINUS 0x2d // 45 Keyboard - and =
  #define KEY_HAT 0x2e // 46 Keyboard ^ and ~
  #define KEY_AT 0x2f // 47 Keyboard @ and `
  #define KEY_LEFTBRACE 0x30 // 48 Keyboard [ and {
  #define KEY_RIGHTBRACE 0x31 // 49 Keyboard ] and }
  #define KEY_HASHTILDE 0x32 // 50 Keyboard Non-US # and ~
  #define KEY_SEMICOLON 0x33 // 51 Keyboard ; and +
  #define KEY_COLON 0x34 // 52 Keyboard : and *
  #define KEY_KANJI 0x35 // 53 Keyboard Hankaku/Zenkaku
  #define KEY_COMMA 0x36 // 54 Keyboard , and <
  #define KEY_DOT 0x37 // 55 Keyboard . and >
  #define KEY_SLASH 0x38 // 56 Keyboard / and ?
  #define KEY_CAPSLOCK 0x39 // 57 Keyboard Caps Lock
#else
  #define KEY_1 0x1e // Keyboard 1 and !
  #define KEY_2 0x1f // Keyboard 2 and @
  #define KEY_3 0x20 // Keyboard 3 and #
