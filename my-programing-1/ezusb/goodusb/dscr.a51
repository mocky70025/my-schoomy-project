...
.globl _DeviceDscr
.globl _ConfigDscr
.globl _ReportDscr_Mouse
.globl _ReportDscrSize_Mouse
.globl _ReportDscr_Keyboard
.globl _ReportDscrSize_Keyboard
.globl _str0, _str1, _str2

.even
_DeviceDscr:
  .db _DeviceDscrEnd-_DeviceDscr; bLength
  .db 0x01       ; bDescriptorType (DEVICE=1)
  .dw 0x1001     ; bcdUSB (USB spec version)
  ...
  .dw 0x0400     ; idProduct (private prototyping)
...
_ConfigDscr:
  ...
  .db (_ConfigDscrEnd-_ConfigDscr)&0xFF; wTotalLength (LSB)
  .db (_ConfigDscrEnd-_ConfigDscr) >> 8; wTotalLength (MSB)
  .db 0x02       ; bNumInterface (mouse+keyboard=2)
  .db 0x01       ; bConfigurationValue
  .db 0x00       ; iConfiguration
  .db 0x80       ; bmAttributes
  .db 0x32       ; bMaxPower
_InterfaceDscr_Mouse:
  .db 9          ; bLength
...
_ReportDscrSize_Mouse:
  .db _ReportDscrEnd_Mouse-_ReportDscr_Mouse ; wDescriptorLength (LSB)
...
_EndpointDscr_Mouse:
  ...
  .db 0x01       ; bInterval
_InterfaceDscr_Keyboard:
  .db 9          ; bLength
  .db 0x04       ; bDescriptorType (INTERFACE=4)
  .db 0x01       ; bInterfaceNumber (+1)
  .db 0x00       ; bAlternateSetting
  .db 0x01       ; bNumEndpoints
  .db 0x03       ; bInterfaceClass
  .db 0x01       ; bInterfaceSubClass
...
_HIDClassDscr_Keyboard:
  ...
  .db 0x01       ; bNumDescriptors
  .db 0x22       ; bDescriptorType (ReportDescriptor=0x22)
_ReportDscrSize_Keyboard:
  .db _ReportDscrEnd_Keyboard-_ReportDscr_Keyboard ; wDescriptorLength (LSB)
  .db 0x00       ; wDescriptorLength (MSB)
_EndpointDscr_Keyboard:
  .db 7          ; bLength
  .db 0x05       ; bDescriptorType (ENDPOINT=5)
...
_ReportDscr_Mouse:
  ...
  .db 0xc0       ; END_COLLECTION
_ReportDscrEnd_Mouse:

.even
_ReportDscr_Keyboard:
  .db 0x05, 0x01 ; USAGE_PAGE (Generic Desktop)
